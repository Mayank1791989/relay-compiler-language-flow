 ...
 * type NAME = any;
 */
function anyTypeAlias(name: string) {
...
function exactObjectTypeAnnotation(
  props: Array<BabelNodeObjectTypeProperty | BabelNodeObjectTypeSpreadProperty>,
) {
 ...
 */
function exportType(name: string, type: BabelNodeFlowType) {
 ...
 * TYPES[0] & TYPES[1] & ...
 */
function intersectionTypeAnnotation(types: Array<BabelNodeFlowType>) {
  invariant(
    types.length > 0,
 ...
 * $ReadOnlyArray<TYPE>
 */
function readOnlyArrayOfType(thing: BabelNodeFlowType) {
 ...
 * +KEY: VALUE
 */
function readOnlyObjectTypeProperty(key: string, value: BabelNodeFlowType) {
 ...
 * TYPES[0] | TYPES[1] | ...
 */
function unionTypeAnnotation(types: Array<BabelNodeFlowType>) {
  invariant(
    types.length > 0,
